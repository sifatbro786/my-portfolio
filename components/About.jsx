        ...
        <div className="min-h-screen px-96 flex flex-col items-center justify-center">
            ...
            <div className="w-full flex items-center justify-between md:justify-center">
                ...
                <div className="relative max-w-[800px] rounded-xl bg-zinc-100 p-5 text-justify">
                    ...
                    <p className="text-lg font-light text-gray-700 first-letter:pl-3 lg:text-base sm:text-[14px]">
                        {aboutText}
                    </p>
                    <a
                        href="/sifat-cv.pdf"
                        download=""
                        className="w-max flex items-center gap-x-2 mt-6 rounded-full border border-gray-300 bg-red-500 hover:bg-red-600 px-3 py-2 font-light text-white transition-colors"
                    >
