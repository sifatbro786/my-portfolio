...
export default function Experience() {
    ...
    return (
        <div id="experience" className="relative max-w-5xl mx-auto py-36">
            ...
            <Image
                ...
                width={400}
                height={400}
                className="absolute sm:hidden top-24 right-0 opacity-70 lg:hidden"
            />
            <div
                ref={containerRef}
                className="relative w-full h-full flex flex-col items-center justify-center gap-y-10 lg:gap-y-20 sm:py-20 py-10"
            >
                {experienceData.map((data, i) => (
                    ...
                    >
                        ...
                        <div
                            className={`w-14 absolute sm:-top-10 top-20 border border-gray-300 rounded-full aspect-square grid place-items-center text-red-400 font-light -translate-y-1/2 z-10 bg-white ${
                                i % 2 === 0
